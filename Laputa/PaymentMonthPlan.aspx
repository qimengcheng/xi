<%@ Page Title="" Language="C#" MasterPageFile="~/Other/MasterPage.master" AutoEventWireup="true" CodeFile="PaymentMonthPlan.aspx.cs" Inherits="Laputa_PaymentMonthPlan" %>
                ...
                <fieldset>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td >
                                <asp:Button ID="NewMonthPlan" runat="server" CssClass="Button02" OnClick="NewMonthPlan_Click" Text=" 新增付款月计划" Width="107px" />
                                <asp:Label ID="MonthPlanID" runat="server" Text="MonthPlanID" Visible="False"></asp:Label>
                            </td>
                            <td>
            ...
            <asp:Panel ID="Panel2" runat="server">
                <fieldset>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"  AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="PaymentMP_ID" HeaderText="PaymentMP_ID" Visible="false"  />
                            <asp:BoundField DataField="PaymentMP_Year" HeaderText="年" Visible="true"  />
                            <asp:BoundField DataField="PaymentMP_Month" HeaderText="月" Visible="true"  />
                            <asp:BoundField DataField="PaymentMP_TotalMoney" HeaderText="付款总额" Visible="true"  />
                            <asp:BoundField DataField="PaymentMP_Startdate" HeaderText="计划开始日期" DataFormatString="{0:yyyy-MM-dd }" />
                            <asp:BoundField DataField="PaymentMP_Enddate" HeaderText="计划结束日期" DataFormatString="{0:yyyy-MM-dd }" />
                            <asp:BoundField DataField="PaymentMP_Man" HeaderText="计划制定人" Visible="true"  />
                            <asp:BoundField DataField="PaymentMP_Time" HeaderText="制定时间" Visible="true"  />
                            <asp:BoundField DataField="PaymentMP_Note" HeaderText="备注" Visible="true"  />


                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="Details" runat="server" CommandArgument='<%# Eval("PaymentMP_ID") %>' CommandName="Details">详细</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="Make" runat="server" CommandArgument='<%# Eval("PaymentMP_ID") %>' CommandName="Make">制定</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <asp:Panel ID="Panel3" runat="server" Visible="False">
                <fieldset>
                    ...
                    <asp:GridView ID="GridView2" runat="server" CssClass="GridViewStyle"  AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <FooterStyle CssClass="GridViewFooterStyle" />
                        <Columns>
                            <asp:BoundField DataField="PaymentMPDetail_ID" HeaderText="PaymentMPDetail_ID" Visible="false"  />
                            <asp:BoundField DataField="PaymentMP_Year" HeaderText="年" Visible="true"  />
                            <asp:BoundField DataField="PaymentMP_Month" HeaderText="月" Visible="true"  />
                            ...
                            <asp:BoundField DataField="PlanPay" HeaderText="计划付款" Visible="true"  />
                               ...
                               <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="Del" runat="server" CommandArgument='<%# Eval("PaymentMPDetail_ID") %>' CommandName="Del">删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
...
></asp:TextBox>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 66px">&nbsp;&nbsp;</td>
                            <td>
                                <asp:Button ID="NewDetailSummit" runat="server" CssClass="Button02" OnClick="NewDetailSummit_Click" Text=" 加入付款月计划" Width="93px" />
                            </td>
                            <td>&nbsp;&nbsp;</td>
                            <td style="width: 69px"></td>
                            <td style="width: 115px">&nbsp;</td>
                            <td>&nbsp;<asp:Button ID="Button2" runat="server" CssClass="Button02" OnClick="Close_Pay_Click" Text=" 关闭" Width="66px" />
                            </td>
                            <td style="width: 205px">&nbsp;</td>
                            <td></td>
                        </tr>

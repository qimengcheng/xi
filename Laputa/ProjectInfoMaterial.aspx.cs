...
public partial class Laputa_ProjectInfoMaterial : Page
{
    ...
    protected void print(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/report_cc/ProjectInfoMaterialPrint.aspx?stime=" + TextBox5.Text + "&etime=" +
                          TextBox6.Text);
    }
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            SqlDataReader reader = lpp.Query_ProjectReportMaterialBad(e.Row.Cells[3].Text, e.Row.Cells[1].Text, Convert.ToDateTime(TextBox5.Text),
             Convert.ToDateTime(TextBox6.Text));

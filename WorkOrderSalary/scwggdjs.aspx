<%@ Page Title="" Language="C#" MasterPageFile="~/other/MasterPage.master" AutoEventWireup="true"
    CodeFile="scwggdjs.aspx.cs" Inherits="WorkOrderSalary_scwggdjs" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel_NewProjectInfo" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="Panel_NewProjectInfo" runat="server" Visible="False">
                <fieldset>
                    <legend>
                        <asp:Label ID="Label1" runat="server" Text="新增提报信息"></asp:Label><asp:Label ID="Label_TNUTID_EDIT"
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td align="left" style="width: 221px">
                                ...
                                <asp:Button ID="Button8" runat="server" CssClass="Button02" Text="选择.." Width="52px"
                                    Height="20px" OnClick="Button8_Click" />
                            </td>
                            <td align="left">
                                初审核部门：<asp:DropDownList ID="DropDownList2" runat="server">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 221px">
                                <asp:Button ID="Button6" runat="server" CssClass="Button02" Height="24px" Text="确定"
            ...
            <asp:Panel ID="Panel_WOmain" runat="server" Visible="true">
                <fieldset>
                    ...
                    <asp:GridView ID="GridView_WOmain" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle"
                        ...
                        AllowSorting="True" Width="100%" DataKeyNames="TNFT_ID,TI_ID,TNFT_Date,STI_Name,BDOS_Name,TNFT_NO,TNFT_Auditor,TNFT_AuTime,TNFT_AuRes,TNFT_AuSuggs,TNFT_RSman,TNFT_RSTime,TNFT_RSResult,TNFT_RSSuggs,TNFT_CWman,TNFT_CWTime,TNFT_CWReult,TNFT_CWSuggs,TNFT_Sate"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TNFT_ID" SortExpression="TNFT_ID" HeaderText="提报ID" Visible="false">
                            </asp:BoundField>
                            <asp:BoundField DataField="TI_ID" SortExpression="TI_ID" HeaderText="计件项目ID" Visible="False">
                            </asp:BoundField>
                            <asp:BoundField DataField="TNFT_NO" SortExpression="TNFT_NO" HeaderText="提报单号"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_Date" SortExpression="TNFT_Date" HeaderText="所属日期"
                                DataFormatString="{0:yy-MM-dd}"></asp:BoundField>
                            <asp:BoundField DataField="STI_Name" SortExpression="STI_Name" HeaderText="计时项目">
                            </asp:BoundField>
                            <asp:BoundField DataField="TNFT_SubmitMan" SortExpression="TNFT_SubmitMan" HeaderText="提报人">
                            </asp:BoundField>
                            <asp:BoundField DataField="TNFT_SubmitTime" SortExpression="TNFT_SubmitTime" HeaderText="提报时间"
                                DataFormatString="{0:yy-MM-dd HH:mm}"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_Sate" SortExpression="TNFT_Sate" HeaderText="状态">
                            </asp:BoundField>
                            <asp:BoundField DataField="TNFT_Auditor" SortExpression="TNFT_Auditor" HeaderText="初审人">
                            </asp:BoundField>
                            <asp:BoundField DataField="BDOS_Name" SortExpression="BDOS_Name" HeaderText="初审部门">
                            </asp:BoundField>
                            <asp:BoundField DataField="TNFT_AuTime" SortExpression="TNFT_AuTime" HeaderText="初审时间"
                                DataFormatString="{0:yyyy-MM-dd}"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_AuRes" SortExpression="TNFT_AuRes" HeaderText="初审结果">
                            </asp:BoundField>
                            <asp:BoundField DataField="TNFT_AuSuggs" SortExpression="TNFT_AuSuggs" HeaderText="初审意见">
                            </asp:BoundField>
                            <asp:BoundField DataField="TNFT_RSman" SortExpression="TNFT_RSman" HeaderText="人事审核人"
                                Visible="False"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_RSTime" SortExpression="TNFT_RSTime" HeaderText="人事审核时间"
                                DataFormatString="{0:yyyy-MM-dd}" Visible="False"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_RSResult" SortExpression="TNFT_RSResult" HeaderText="人事结果"
                                Visible="False"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_RSSuggs" SortExpression="TNFT_RSSuggs" HeaderText="人事意见"
                                Visible="False"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_CWman" SortExpression="TNFT_CWman" HeaderText="财务审核人"
                                Visible="False"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_CWTime" SortExpression="TNFT_CWTime" HeaderText="财务审核时间"
                                DataFormatString="{0:yyyy-MM-dd}" Visible="False"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_CWReult" SortExpression="TNFT_CWReult" HeaderText="财务结果"
                                Visible="False"></asp:BoundField>
                            <asp:BoundField DataField="TNFT_CWSuggs" SortExpression="TNFT_CWSuggs" HeaderText="财务意见"
                                Visible="False"></asp:BoundField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="EDIT123" runat="server" CommandName="EDIT123" CommandArgument='<%#Eval("TNFT_ID") %>'>编辑</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="DeleteWTP" runat="server" CommandName="DeleteWTP" CommandArgument='<%#Eval("TNFT_ID") %>'
                                        OnClientClick="return confirm('将会删除计时计件信息，确定吗？')">删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="Detail123" runat="server" CommandName="Detail123" CommandArgument='<%#Eval("TNFT_ID") %>'>详情</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <PagerTemplate>
                ...
                <fieldset>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 51px">
                                <asp:Button ID="Button1" runat="server" CssClass="Button02" Height="24px" Width="70px"
                                    OnClick="Button1_Click" Text="检索" />
                            </td>
                            <td align="center">
                            </td>
                            <td align="center" style="width: 155px">
                            ...
                            <td align="center" style="width: 155px">
                                <asp:Button ID="Button10" runat="server" CssClass="Button02" Height="24px" OnClick="Button10_Click"
                    ...
                    <table id="pl" runat="server" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="3">
                                <asp:TextBox ID="TextBox10" runat="server" Width="90%"></asp:TextBox>
                                &nbsp; &nbsp; &nbsp;&nbsp;</td>
                            <td align="center" style="width: 155px">
                                <asp:Button ID="Button11" runat="server" CssClass="Button02" Height="24px" 
                                    OnClick="Button11_Click" Text="批处理本页员工" Width="100px" />
                            </td>
                            <td align="center" style="width: 155px">
                                &nbsp;
                            </td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle"
                        ...
                        Width="100%" DataKeyNames="TNFD_ID" EmptyDataText="无相关记录!" GridLines="None" OnRowCommand="GridView_AddProject_RowCommand">
                        <RowStyle CssClass="GridViewRowStyle" />
                        <SelectedRowStyle CssClass="GridViewSelectedRowStyle" />
                        <AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" />
                        <HeaderStyle CssClass="GridViewHead" />
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TNFD_ID" HeaderText="详细ID" Visible="false"></asp:BoundField>
                            ...
                            <asp:BoundField DataField="TNFD_TimeLength" HeaderText="计时时长"></asp:BoundField>
                            <asp:TemplateField HeaderText="计时时长" SortExpression="TNFD_TimeLength" Visible="true">
                                <ItemTemplate>
                                    <asp:TextBox ID="txttime" runat="server" Width="85%" Text='<%#Eval("TNFD_TimeLength")%>'></asp:TextBox>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="TNFD_Num" HeaderText="产量"></asp:BoundField>
                            <asp:TemplateField HeaderText="产量" SortExpression="TNFD_Num" Visible="true">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtnum" runat="server" Width="85%" Text='<%#Eval("TNFD_Num")%>'></asp:TextBox>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="TNFD_Note" HeaderText="备注"></asp:BoundField>
                            <asp:TemplateField HeaderText="备注" SortExpression="TNFD_Note" Visible="true">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtnote" runat="server" Width="85%" Text='<%#Eval("TNFD_Note")%>'
                        ...
                        <tr>
                            <td style="width: 46px;">
                                <asp:CheckBox ID="CheckBoxAll" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBoxAll_CheckedChanged"
                                    Style="margin-left: 0px" Text="全选" Width="55px" />
                            </td>
                            <td style="width: 28px">
                                <asp:CheckBox ID="CheckBoxfanxuan" runat="server" AutoPostBack="True" OnCheckedChanged="Checkfanxuan_CheckedChanged"
                                    Text="反选" Width="103px" />
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Button ID="Btn_deleting0" runat="server" CssClass="Button02" Height="24px" OnClick="Btn_tj_Click"
                                    Text="提交" Width="70px" />
                            </td>
                            <td>
                                <asp:Button ID="Btn_deleting1" runat="server" CssClass="Button02" Height="24px" OnClick="Btn_save_Click"
                                    Text="保存" Width="70px" />
                            </td>
                            <td>
                                &nbsp;
                ...
                <fieldset>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style="width: 196px">
                                初审部门：<asp:Label ID="Label53" runat="server"></asp:Label>
                            </td>
                            <td>
                                初审审核结果：<asp:Label ID="label7" runat="server" ForeColor="Red" Visible="true"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table style="width: 100%">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                人事审核结果：<asp:Label ID="label51" runat="server" ForeColor="Red" Visible="true"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table style="width: 100%">

<%@ Page Title="" Language="C#" MasterPageFile="~/other/MasterPage.master" AutoEventWireup="true"
    CodeFile="jsbl.aspx.cs" Inherits="WorkOrderSalary_jsbl" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel_WOmain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="Panel_WOmain" runat="server" Visible="true">
                <fieldset>
                    <legend>计时补录审核表<asp:Label ID="label_GridPageState" runat="server" Visible="False"></asp:Label>
                    </legend>
                    <asp:GridView ID="GridView_WOmain" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle"
                        ...
                        AllowSorting="True" Width="100%" DataKeyNames="JSBL_ID,JSBL_NO,JSBL_Man,JSBL_Time,JSBL_State,JSBL_ShMan,JSBL_ShTime,JSBL_ShRes,JSBL_ShSugg"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="JSBL_ID" SortExpression="JJBL_ID" HeaderText="计件补录ID"
                                Visible="False"></asp:BoundField>
                            <asp:BoundField DataField="JSBL_NO" SortExpression="JJBL_NO" HeaderText="补录单号"></asp:BoundField>
                            <asp:BoundField DataField="JSBL_Man" SortExpression="JJBL_Man" HeaderText="补录人">
                            </asp:BoundField>
                            <asp:BoundField DataField="JSBL_Time" SortExpression="JJBL_Time" HeaderText="补录时间"
                                DataFormatString="{0:yy-MM-dd HH:mm}"></asp:BoundField>
                            <asp:BoundField DataField="JSBL_State" SortExpression="JJBL_State" HeaderText="状态">
                            </asp:BoundField>
                            <asp:BoundField DataField="JSBL_Note" SortExpression="JJBL_Note" HeaderText="备注">
                            </asp:BoundField>
                            <asp:BoundField DataField="JSBL_ShMan" SortExpression="JJBL_ShMan" HeaderText="审核人">
                            </asp:BoundField>
                            <asp:BoundField DataField="JSBL_ShTime" SortExpression="JJBL_ShTime" HeaderText="审核时间"
                                DataFormatString="{0:yy-MM-dd HH:mm}"></asp:BoundField>
                            <asp:BoundField DataField="JSBL_ShRes" SortExpression="JJBL_ShRes" HeaderText="审核结果">
                            </asp:BoundField>
                            <asp:BoundField DataField="JSBL_ShSugg" SortExpression="JJBL_ShSugg" HeaderText="审核意见">
                            </asp:BoundField>
                            <asp:TemplateField>
                                <ItemTemplate>
        ...
        <ContentTemplate>
                ...
                <fieldset>
                    ...
                    <table width="100%">
                        <tr>
                            <td style="width: 200px">
                                <asp:Label ID="Label5" runat="server" ForeColor="Red" Text="批量选择勾选项的计时项目："></asp:Label>
                            </td>
                            <td style="width: 100px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="计时项目" HeaderText="计时项目"></asp:BoundField>
                            <asp:BoundField DataField="补录产量" HeaderText="补录产量"></asp:BoundField>
                            <asp:TemplateField HeaderText="补录产量" SortExpression="补录产量">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtPlan" runat="server" Width="70px" Text='<%#Eval("补录产量")%>'></asp:TextBox>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="补录工时" HeaderText="补录工时"></asp:BoundField>
                            <asp:TemplateField HeaderText="补录工时" SortExpression="补录工时">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtPlan1" runat="server" Width="70px" Text='<%#Eval("补录工时")%>'></asp:TextBox>
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" />
                            </asp:TemplateField>
            ...
            <asp:Panel ID="Panel3" runat="server" Visible="False">
                <fieldset>
                    ...
                    <asp:Label ID="Label13" runat="server" Text="所选计时提报单号：" Visible="False"></asp:Label>

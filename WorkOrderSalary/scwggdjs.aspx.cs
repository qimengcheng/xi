...
public partial class WorkOrderSalary_scwggdjs : System.Web.UI.Page
{
    ...
    public void databind_zhubiao()
    {
        ...
        string TNUT_NO = TextBox_NO.Text.Trim() == "" ? " and 1=1 " : " and TNFT_NO like '%" + TextBox_NO.Text.Trim() + "%' ";
        string TNUT_State = DropDownList1.SelectedItem.Text.Trim() == "请选择" ? " and 1=1 " : " and TNFT_Sate like '%" + DropDownList1.SelectedItem.Text.Trim() + "%' ";
        string TNUT_SubmitMan = TextBox_tibaoren.Text.Trim() == "" ? " and 1=1 " : " and TNFT_SubmitMan like '%" + TextBox_tibaoren.Text.Trim() + "%' ";
        string TNUT_Auditor = TextBox_chushengren.Text.Trim() == "" ? " and 1=1 " : " and TNFT_Auditor like '%" + TextBox_chushengren.Text.Trim() + "%' ";
        string TNUT_RSAuditor = TextBox_renshishenghe.Text.Trim() == "" ? " and 1=1 " : " and TNFT_RSman like '%" + TextBox_renshishenghe.Text.Trim() + "%' ";
        string TNUT_CWAuditor = TextBox_caiwuren.Text.Trim() == "" ? " and 1=1 " : " and TNFT_CWman like '%" + TextBox_caiwuren.Text.Trim() + "%' ";
        ...
        string TNUT_Date = (TextBox_WO_Time1.Text.Trim() == "" && TextBox_WO_Time2.Text.Trim() == "") ? " and 1=1 " : " and TNFT_Date between   ' " + TextBox_WO_Time1.Text.Trim() + "' and ' " + TextBox_WO_Time2.Text.Trim() + "'";
        ...
        string TNUT_SubmitTime = (TextBox_tibaoshijian1.Text.Trim() == "" && TextBox_tibaoshijian2.Text.Trim() == "") ? " and 1=1 " : " and TNFT_SubmitTime between   ' " + TextBox_tibaoshijian1.Text.Trim() + "' and ' " + TextBox_tibaoshijian2.Text.Trim() + "'";
        ...
        string TNUT_AuTime = (TextBox_chushengshijian1.Text.Trim() == "" && TextBox_chushengshijian2.Text.Trim() == "") ? " and 1=1 " : " and TNFT_AuTime between   ' " + TextBox_chushengshijian1.Text.Trim() + "' and ' " + TextBox_chushengshijian2.Text.Trim() + "'";
        ...
        string TNUT_RSTime = (TextBox_renshishijian1.Text.Trim() == "" && TextBox_renshishijian2.Text.Trim() == "") ? " and 1=1 " : " and TNFT_RSTime between   ' " + TextBox_renshishijian1.Text.Trim() + "' and ' " + TextBox_renshishijian2.Text.Trim() + "'";
        ...
        string TNUT_CWTime = (TextBox_caiwushijian1.Text.Trim() == "" && TextBox_caiwushijian2.Text.Trim() == "") ? " and 1=1 " : " and TNFT_CWTime between   ' " + TextBox_caiwushijian1.Text.Trim() + "' and ' " + TextBox_caiwushijian2.Text.Trim() + "'";
        ...
        GridView_WOmain.DataSource = ws.S_TimeNoFixedTable(condition);
    ...
    public void databind_detail()
    {
        ...
        GridView1.DataSource = ws.S_TimeNoFixedDetail(Label_TNUT_ID.Text.Trim(), condition);
        GridView1.DataBind();
        UpdatePanel1.Update();
    }
    ...
    protected void Button_AddTeam_Click(object sender, EventArgs e)//新增提报单
    {
        ...
        while (myReader.Read())
        {
            if (myReader["BDOS_Name"].ToString() == "生产一部" || myReader["BDOS_Name"].ToString() == "生产二部" || myReader["BDOS_Name"].ToString() == "模块事业部")
            {
    ...
    protected void Button6_Click(object sender, EventArgs e)//提交新增计时项目信息
    {
        if (Label1.Text.Contains("新增"))
        {
            ...
            try
            {
                ws.I_TimeNoFixedTable(new Guid(Label17.Text.Trim()), Convert.ToDateTime(TextBox_WO_Time12.Text.Trim()), Session["UserName"].ToString().Trim(), DropDownList2.SelectedValue.ToString().Trim());
        ...
        if (Label1.Text.Contains("编辑"))
        {
            ...
            try
            {
                ws.U_TimeNoFixedTable(new Guid(Label_TNUTID_EDIT.Text.Trim()), new Guid(Label17.Text.Trim()), Convert.ToDateTime(TextBox_WO_Time12.Text.Trim()), Session["UserName"].ToString().Trim(), DropDownList2.SelectedValue.ToString().Trim());
    ...
    protected void GridView_WOmain_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "DeleteWTP")//
        {
            ...
            try
            {
                ws.D_TimeNoFixedTable(new Guid(GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_ID"].ToString()));
        ...
        {
            GridViewRow row = ((LinkButton)e.CommandSource).Parent.Parent as GridViewRow;
            Label_TNUTID_EDIT.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_ID"].ToString();
            TextBox_WO_Time12.Text = Convert.ToDateTime(GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_Date"].ToString()).ToString("yyyy-MM-dd");
            ...
            Label1.Text = "编辑提报单 " + GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_NO"].ToString().Trim() + " 的提报信息";
            SqlDataReader myReader = Us.Query_Organization();
            DropDownList2.Items.Clear();
            DropDownList2.Items.Add(new ListItem("所有部门", "null"));//增加I
            while (myReader.Read())
        ...
        if (e.CommandName == "Detail123")//
        {
            Label21.Text = "";
            GridViewRow row = ((LinkButton)e.CommandSource).Parent.Parent as GridViewRow;
            Label22.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_NO"].ToString().Trim();
            TextBox4.Enabled = false;
            Button5.Visible = false;
            Button9.Visible = false;
            TextBox3.Enabled = false;
            ...
            {
                if (GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_Sate"].ToString().Trim() != "待提交")
                {
                    GridView1.Columns[0].Visible = false;//详细表check
                    CheckBoxAll.Visible = false;//详细表全选
                    CheckBoxfanxuan.Visible = false;//详细表全不选
            ...
            if (GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_Sate"].ToString().Trim() == "初审待审")
            {
                if (label_pagestate.Text.Trim() == "cs")
                {
            ...
            if (GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_Sate"].ToString().Trim() == "人事待审")
            {
            ...
            if (GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_Sate"].ToString().Trim() == "财务待审")
            {
            ...
            Label13.Visible = false;
            Label14.Visible = false;
            Label_TNUT_ID.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_ID"].ToString().Trim();
            Label4.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_Auditor"].ToString().Trim();//初审审核人
            Label6.Text = (GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_AuTime"].ToString().Trim() == "&nbsp;" || GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_AuTime"].ToString().Trim() == "") ? "" : Convert.ToDateTime(GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_AuTime"].ToString().Trim()).ToString("yy-MM-dd HH:mm");//初审审核时间
            Label53.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["BDOS_Name"].ToString().Trim();//初审审核部门
            label7.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_AuRes"].ToString().Trim();//初审审核结果
            TextBox4.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_AuSuggs"].ToString().Trim();//初审意见

            Label15.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_RSman"].ToString().Trim();//人事审核人
            Label5.Text = (GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_RSTime"].ToString().Trim() == "&nbsp;" || GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_RSTime"].ToString().Trim() == "") ? "" : Convert.ToDateTime(GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_RSTime"].ToString().Trim()).ToString("yy-MM-dd HH:mm");//人事审核时间
            label51.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_RSResult"].ToString().Trim();//人事审核结果
            TextBox3.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_RSSuggs"].ToString().Trim();//人事意见

            Label41.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_CWman"].ToString().Trim();//财务审核人
            Label42.Text = (GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_CWTime"].ToString().Trim() == "&nbsp;" || GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_CWTime"].ToString().Trim() == "") ? "" : Convert.ToDateTime(GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_CWTime"].ToString().Trim()).ToString("yy-MM-dd HH:mm");//财务审核时间
            label52.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_CWReult"].ToString().Trim();//财务审核结果
            TextBox7.Text = GridView_WOmain.DataKeys[row.RowIndex].Values["TNFT_CWSuggs"].ToString().Trim();//财务意见
            Panel1.Visible = true;
            Panel3.Visible = true;
            databind_detail();
    ...
    protected void CheckBoxAll2_CheckedChanged(object sender, EventArgs e)
    {
        for (int i = 0; i <= GridView_WOmain.Rows.Count - 1; i++)
        {
            ...
            if (label_pagestate.Text.Trim() == "cs")
            {
                if (GridView_WOmain.DataKeys[i].Values["TNFT_Sate"].ToString().Trim() == "初审待审")
                {
            ...
            if (label_pagestate.Text.Trim() == "rs")
            {
                if (GridView_WOmain.DataKeys[i].Values["TNFT_Sate"].ToString().Trim() == "人事待审")
                {
                    if (CheckBox2.Checked == true)
                    {
                        CheckBox.Checked = true;
            ...
            if (label_pagestate.Text.Trim() == "cw")
            {
                if (GridView_WOmain.DataKeys[i].Values["TNFT_Sate"].ToString().Trim() == "财务待审")
                {
                    if (CheckBox2.Checked == true)
                    {
                        CheckBox.Checked = true;
    ...
    protected void Button_AddPTToSeries_Click(object sender, EventArgs e)//审核
    {
        ...
        for (int i = 0; i <= GridView_WOmain.Rows.Count - 1; i++)
        {
            ...
            if (CheckBox.Checked == true)
            {
                ...
                {
                    Label14.Text = GridView_WOmain.DataKeys[i].Values["TNFT_NO"].ToString().Trim();
                }
                else
                {
                    string[] a;
                    if (Label14.Text.Contains(","))
                    {
                        ...
                        int id = Array.IndexOf(a, GridView_WOmain.DataKeys[i].Values["TNFT_NO"].ToString().Trim()); // 这里的1就是你要查找的值
                        if (id == -1)
                        {
                            Label14.Text = Label14.Text + "," + GridView_WOmain.DataKeys[i].Values["TNFT_NO"].ToString().Trim();
                        }
                    }
                    else
                    {
                        if (Label14.Text != GridView_WOmain.DataKeys[i].Values["TNFT_NO"].ToString().Trim())
                        {
                            Label14.Text = Label14.Text + "," + GridView_WOmain.DataKeys[i].Values["TNFT_NO"].ToString().Trim();
                        }
                    }
                ...
                {
                    Label21.Text = GridView_WOmain.DataKeys[i].Values["TNFT_ID"].ToString().Trim();
                }
                else
                {
                    string[] a;
                    if (Label21.Text.Contains(","))
                    {
                        ...
                        int id = Array.IndexOf(a, GridView_WOmain.DataKeys[i].Values["TNFT_ID"].ToString().Trim()); // 这里的1就是你要查找的值
                        if (id == -1)
                        {
                            Label21.Text = Label21.Text + "," + GridView_WOmain.DataKeys[i].Values["TNFT_ID"].ToString().Trim();
                        }
                    }
                    else
                    {
                        if (Label21.Text != GridView_WOmain.DataKeys[i].Values["TNFT_ID"].ToString().Trim())
                        {
                            Label21.Text = Label21.Text + "," + GridView_WOmain.DataKeys[i].Values["TNFT_ID"].ToString().Trim();
                        }
                    }
    ...
    protected void GridView_WOmain_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (drv["TNFT_Sate"].ToString().Trim() == "待提交")
            {
        ...
        if (label_pagestate.Text.Trim() == "cs")
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (drv["TNFT_Sate"].ToString().Trim() == "初审待审")
                {
        ...
        if (label_pagestate.Text.Trim() == "rs")
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (drv["TNFT_Sate"].ToString().Trim() == "人事待审")
                {
                    e.Row.Cells[0].Enabled = true;
        ...
        if (label_pagestate.Text.Trim() == "cw")
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (drv["TNFT_Sate"].ToString().Trim() == "财务待审")
                {
                    e.Row.Cells[0].Enabled = true;
        ...
        for (int i = 0; i <= GridView1.Rows.Count - 1; i++)
        {
            ...
            if (CheckBox.Checked == true)
            {
                try
                {
                    ...
                    Guid TNUD_ID = new Guid(GridView1.DataKeys[i].Values["TNFD_ID"].ToString().Trim());
                    ws.D_TimeNoFixedDetail(TNUD_ID);
                    sum++;
                }
                catch (Exception)
                {
        ...
        for (int i = 0; i <= GridView_People.Rows.Count - 1; i++)
        {
            ...
            if (CheckBox.Checked == true)
            {
                try
                {
                    ...
                    ws.I_TimeNoFixedDetail(TNUT_ID, hrddid);
                    sum++;
                }
                catch (Exception)
                {
    ...
    protected void Btn_save_Click(object sender, EventArgs e)//保存
    {
        ...
        {
            TNUD_ID = new Guid(GridView1.DataKeys[i].Values["TNFD_ID"].ToString());
            ...
            try
            {
                ...
                note = ((TextBox)(GridView1.Rows[i].FindControl("txtnote"))).Text.Trim();
            }
            catch (Exception)
            {
            ...
            ws.U_TimeNoFixedDetail(TNUD_ID, t, num,note);
        }
    ...
    protected void Btn_tj_Click(object sender, EventArgs e)
    {
        try
        {
            ws.U_TimeNoFixedTable_tj(new Guid(Label_TNUT_ID.Text.Trim()));

            ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('提交成功！')", true);
            string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "提交了生产无关固定计时单： " + Label14.Text + " ！";
    ...
    protected void cstg_Click(object sender, EventArgs e)
    {
        if (Label21.Text.Trim() != "")
        {
            if (Label21.Text.Contains(","))
            {
                ...
                if (Label21.Text.Contains(","))
                {
                    ...
                    try
                    {
                        ...
                        {
                            ws.U_TimeNoFixedTable_Review(new Guid(a[i].Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "通过", 1);
                        }
                        ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                        string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "初审通过了生产无关固定计时单： " + Label14.Text + " ，请您进行人事审核！";
                        string ms = "";
                        try
                        {
            ...
            else
            {
                try
                {
                    ...
                    ws.U_TimeNoFixedTable_Review(new Guid(Label21.Text.Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "通过", 1);
        ...
        else
        {
            try
            {
                ws.U_TimeNoFixedTable_Review(new Guid(Label_TNUT_ID.Text.Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "通过", 1);
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "初审通过了生产无关固定计时单： " + Label22.Text + " ，请您进行人事审核！";
    ...
    protected void csbh_Click(object sender, EventArgs e)
    {
        if (Label21.Text.Trim() != "")
        {
            if (Label21.Text.Contains(","))
            {
                ...
                if (Label21.Text.Contains(","))
                {
                    ...
                    try
                    {
                        for (int i = 0; i < a.Length; i++)
                        {
                            ws.U_TimeNoFixedTable_Review(new Guid(a[i].Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "不通过", 1);
                        }
                        ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                        string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "初审驳回了生产无关固定计时单： " + Label14.Text + " ！";
            ...
            else
            {
                try
                {
                    ...
                    ws.U_TimeNoFixedTable_Review(new Guid(Label21.Text.Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "不通过", 1);
        ...
        else
        {
            try
            {
                ws.U_TimeNoFixedTable_Review(new Guid(Label_TNUT_ID.Text.Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "不通过", 1);
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "初审驳回了生产无关固定计时单： " + Label22.Text + " ！";
    ...
    protected void sctg_Click(object sender, EventArgs e)//人事审核通过
    {
        if (Label21.Text.Trim() != "")
        {
            if (Label21.Text.Contains(","))
            {
                ...
                if (Label21.Text.Contains(","))
                {
                    ...
                    try
                    {
                        for (int i = 0; i < a.Length; i++)
                        {
                            ws.U_TimeNoFixedTable_Review(new Guid(a[i].Trim()), Session["UserName"].ToString(), TextBox3.Text.Trim(), "通过", 2);
                        }
                        ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                        string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "人事审核通过了生产无关固定计时单： " + Label14.Text + " ！";
            ...
            else
            {
                try
                {
                    ...
                    ws.U_TimeNoFixedTable_Review(new Guid(Label21.Text.Trim()), Session["UserName"].ToString(), TextBox3.Text.Trim(), "通过", 2);
        ...
        else
        {
            try
            {
                ws.U_TimeNoFixedTable_Review(new Guid(Label_TNUT_ID.Text.Trim()), Session["UserName"].ToString(), TextBox3.Text.Trim(), "通过", 2);
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "人事审核通过了生产无关固定计时单： " + Label22.Text + " ！";
    ...
    protected void scbh_Click(object sender, EventArgs e)//人事审核不通过
    {
        if (Label21.Text.Trim() != "")
        {
            if (Label21.Text.Contains(","))
            {
                ...
                if (Label21.Text.Contains(","))
                {
                    ...
                    try
                    {
                        for (int i = 0; i < a.Length; i++)
                        {
                            ws.U_TimeNoFixedTable_Review(new Guid(a[i].Trim()), Session["UserName"].ToString(), TextBox3.Text.Trim(), "不通过", 2);
                        }
                        ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                        string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "人事审核驳回了生产无关固定计时单： " + Label14.Text + " ！";
            ...
            else
            {
                try
                {
                    ...
                    ws.U_TimeNoFixedTable_Review(new Guid(Label21.Text.Trim()), Session["UserName"].ToString(), TextBox3.Text.Trim(), "不通过", 2);
        ...
        else
        {
            try
            {
                ws.U_TimeNoFixedTable_Review(new Guid(Label_TNUT_ID.Text.Trim()), Session["UserName"].ToString(), TextBox3.Text.Trim(), "不通过", 2);
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "人事审核驳回了生产无关固定计时单： " + Label22.Text + " ！";
    ...
    protected void pbtg_Click(object sender, EventArgs e)//财务审核通过
    {
        if (Label21.Text.Trim() != "")
        {
            if (Label21.Text.Contains(","))
            {
                ...
                if (Label21.Text.Contains(","))
                {
                    ...
                    try
                    {
                        for (int i = 0; i < a.Length; i++)
                        {
                            ws.U_TimeNoFixedTable_Review(new Guid(a[i].Trim()), Session["UserName"].ToString(), TextBox7.Text.Trim(), "通过", 3);
                        }
                        ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                        string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "财务审核通过了生产无关固定计时单： " + Label14.Text + " ！";
            ...
            else
            {
                try
                {
                    ...
                    ws.U_TimeNoFixedTable_Review(new Guid(Label21.Text.Trim()), Session["UserName"].ToString(), TextBox7.Text.Trim(), "通过", 3);
        ...
        else
        {
            try
            {
                ws.U_TimeNoFixedTable_Review(new Guid(Label_TNUT_ID.Text.Trim()), Session["UserName"].ToString(), TextBox7.Text.Trim(), "通过", 3);
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "财务审核通过了生产无关固定计时单： " + Label22.Text + " ！";
    ...
    protected void pbbh_Click(object sender, EventArgs e)//财务审核不通过
    {
        if (Label21.Text.Trim() != "")
        {
            if (Label21.Text.Contains(","))
            {
                ...
                if (Label21.Text.Contains(","))
                {
                    ...
                    try
                    {
                        for (int i = 0; i < a.Length; i++)
                        {
                            ws.U_TimeNoFixedTable_Review(new Guid(a[i].Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "不通过", 3);
                        }
                        ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                        string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "财务审核驳回了生产无关固定计时单： " + Label14.Text + " ！";
            ...
            else
            {
                try
                {
                    ...
                    ws.U_TimeNoFixedTable_Review(new Guid(Label21.Text.Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "不通过", 3);
        ...
        else
        {
            try
            {
                ws.U_TimeNoFixedTable_Review(new Guid(Label_TNUT_ID.Text.Trim()), Session["UserName"].ToString(), TextBox4.Text.Trim(), "不通过", 3);
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('审核成功！')", true);
                string message = "ERP系统信息：" + Session["Department"].ToString() + "的" + Session["UserName"].ToString() + "于" + DateTime.Now + "财务审核驳回了生产无关固定计时单： " + Label22.Text + " ！";
    ...
    protected void Button11_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i <= this.GridView1.Rows.Count - 1; i++)
        {
            ...
            try
            {
                t = TextBox8.Text.Trim() == "" ? 0 : Convert.ToDecimal(TextBox8.Text.Trim());
                num = TextBox9.Text.Trim() == "" ? 0 : Convert.ToInt32(TextBox9.Text.Trim());
                note = TextBox10.Text.Trim();
            }
            catch (Exception)
            {
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "alert", "alert('请您再次核对输入格式，时间为小数、数量为整数！')", true);

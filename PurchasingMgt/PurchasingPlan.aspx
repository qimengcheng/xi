<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchasingPlan.aspx.cs" Inherits="PurchasingMgt_PurchasingPlan"  MasterPageFile="~/Other/MasterPage.master" Title="采购计划管理" %>
                    ...
                    <asp:GridView ID="Gridview_MonthPlan" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PMPPM_Time" HeaderText="制定时间" SortExpression="PMPPM_Time"   DataFormatString="{0:yyyy-MM-dd}">
                              ...
                              <asp:BoundField DataField="PMPPM_CFOCheckOpinion" HeaderText="审核意见" ReadOnly="false" SortExpression="PMPPM_CFOCheckOpinion">
                                <ItemStyle />
                            </asp:BoundField>
                               <asp:BoundField DataField="PMPPM_CFOCheckTime" HeaderText="审核时间" SortExpression="PMPPM_CFOCheckTime"   DataFormatString="{0:yyyy-MM-dd}">
                                <ItemStyle />
                            </asp:BoundField>
                              ...
                              <asp:TemplateField Visible="true">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="Mat1" runat="server" CommandName="Mat1" 
                                        CommandArgument='<%#Eval("PMPPM_ID")%>'>查看材料计划</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <fieldset>
                        ...
                        <Columns>
                          <asp:TemplateField Visible="false">
                            ...
                            <asp:TemplateField HeaderText="采购计划数量" HeaderStyle-Font-Bold="true" Visible="true">
                                <ItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Width="80px" Text='<%#Eval("PMPPD_Num")%>'></asp:TextBox>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField Visible="true">
                                <ItemTemplate>
                                    <asp:LinkButton ID="Edit1" runat="server" CommandName="Edit2" OnClientClick="false"
                                        CommandArgument='<%#Eval("PMPPD_ID")%>'>编辑</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                              <asp:TemplateField Visible="true">
                                <ItemTemplate>
                    ...
                    <tr>
                        <td style="width:30%" align="right">
                                     ...
                                     <asp:Button ID="Button2" runat="server" Text="生成采购订单" CssClass="Button02" Height="24px" Visible="false"
            ...
            <asp:Panel ID="Panel_Week" runat="server" Visible="false">
                ...
                <fieldset>
                    ...
                    <asp:GridView ID="Gridview_Week" runat="server" AutoGenerateColumns="False"
                        CssClass="GridViewStyle" CellPadding="0" UseAccessibleHeader="False" BorderColor="#C0DE98"
                        PageSize="10" AllowPaging="True" AllowSorting="True" DataKeyNames="MWPD_ID,IMMBD_MaterialID" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="MWPD_ID" HeaderText="售后类别ID" ReadOnly="True" SortExpression="MWPD_ID"
                                Visible="False">
                                <ItemStyle Width="100px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="IMMBD_MaterialID" HeaderText="物料ID" ReadOnly="false" SortExpression="IMMBD_MaterialID"
                            ...
                            <asp:BoundField DataField="MWPD_Num" HeaderText="数量" SortExpression="MWPD_Num"  >
                                <ItemStyle />
                            </asp:BoundField>
                             <asp:BoundField DataField="UnitName" HeaderText="单位" SortExpression="UnitName"  >
                                <ItemStyle />
                            </asp:BoundField>
                              <asp:BoundField DataField="MWPD_Note" HeaderText="备注" SortExpression="MWPD_Note"  >
                                <ItemStyle />
                            </asp:BoundField>

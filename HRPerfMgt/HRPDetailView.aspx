<%@ Page Title="绩效管理基础信息维护" Language="C#" MasterPageFile="~/Other/MasterPage.master" AutoEventWireup="true" CodeFile="HRPDetailView.aspx.cs" Inherits="HRPerfMgt_HRPDetailView" %>
                        ...
                        <tr style="height: 16px;">
                            ...
                            <td style="height: 16px; width: 15%">
                              <asp:Button ID="BtnNew" runat="server" CssClass="Button02" Height="24px" OnClick="BtnNew_Click"
                                    Text="新增考核类型" Width="90px" TabIndex="1" CausesValidation="False" Visible="false" />
                            </td>
                            <td >
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnEdit1" runat="server" CommandArgument='<%#Eval("HRPAT_ID")%>'
                                        CommandName="Edit1" OnClientClick="false">查看考核项目</asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnEdit2" runat="server" CommandArgument='<%#Eval("HRPAT_ID")%>'
                                        CommandName="Edit2" OnClientClick="false">查看该考核类型员工</asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle />
                            </asp:TemplateField>
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnEdit3" runat="server" CommandArgument='<%#Eval("HRPAT_ID")%>'
                                        CommandName="Edit3" OnClientClick="false" Visible="false">编辑</asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle />
                            </asp:TemplateField>
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnDelete_Type" runat="server" CommandName="Delete_Type" OnClientClick="return confirm('您确认删除该记录吗?')"
                                        CommandArgument='<%#Eval("HRPAT_ID")%>' Visible="false">删除</asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle />
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="width: 30%; height: 20px;">
                                ...
                                <asp:Button ID="Button3" runat="server" Width="45px" Height="20px" Text="选择..." CssClass="Button02"
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr style="height: 16px;">
                            <td style="width: 10%" align="right" colspan="2">
                                ...
                                <asp:Label ID="Label26" runat="server" Text="检索前" Visible="false"></asp:Label>
            ...
            <asp:Panel ID="Panel2" runat="server" Visible="false">
                <fieldset>
                        ...
                        <tr>
                            ...
                            <td align="center" colspan="2">
                                <asp:Button ID="ButtonItem2" runat="server" CssClass="Button02" Height="24px" Text="新增考核项目"
                                    Width="91px" OnClick="ItemBtnNew_Click" CausesValidation="False" Visible="false" />
                    ...
                    <asp:GridView ID="GridView2" runat="server" AllowSorting="True" DataKeyNames="HRPI_ItemID"
                        ...
                        AllowPaging="True" PageSize="5" Font-Strikeout="False" GridLines="None" UseAccessibleHeader="False"
                        OnRowCancelingEdit="Grid_Type_RowCancelingEdit" OnRowCommand="Grid_Type_RowCommand"
                        OnRowEditing="Grid_Type_RowEditing" OnRowDataBound="Grid_Type_RowDataBound_Item"
                            ...
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnEdit_Post" runat="server" CommandArgument='<%#Eval("HRPI_ItemID")%>'
                                        CommandName="Edit_Post" OnClientClick="false" Visible="false">编辑</asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle />
                            </asp:TemplateField>
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnDelete_Type" runat="server" CommandName="Delete_Type_Item"
                                        OnClientClick="return confirm('您确认删除该记录吗?')" CommandArgument='<%#Eval("HRPI_ItemID")%>' Visible="false">删除</asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle />
                            </asp:TemplateField>
                        </Columns>
                ...
                <fieldset>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 20%; height: 16px;">
                                <asp:TextBox ID="TextBox_newItem3" runat="server" Width="155px" MaxLength="2" onkeyup="this.value=this.value.replace(/[^\d{1,2}]/g,'')"
                        ...
                        <tr>
                            ...
                            <td style="width: 60%; height: 16px;">
                                <asp:TextBox ID="TextBox_newItem2" runat="server" Width="500px" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 10%; height: 16px;" align="center">
                            ...
                            <td style="width: 60%; height: 16px;">
                                <asp:TextBox ID="TextBox_newItem4" runat="server" Width="500px" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr style="height: 16px;">
                            <td style="width: 10%" align="center">
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="center">
                                <asp:Button ID="BtnAddEmployee" runat="server" CssClass="Button02" Height="24px"
                                    Width="70px" Text="新增员工" OnClick="BtnAddEmployee_Click" Visible="false" />
                                            ...
                                            <asp:TemplateField Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnDelete_Detail" runat="server" CommandName="Delete_Detail"
                                                        OnClientClick="return confirm('您确认删除该记录吗?')" CommandArgument='<%#Eval("HRDD_ID")%>' Visible="false">删除</asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle />
                                            </asp:TemplateField>
                                        </Columns>

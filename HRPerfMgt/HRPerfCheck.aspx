<%@ Page Title = "考核结果审核" Language="C#" MasterPageFile="~/Other/MasterPage.master" AutoEventWireup="true" CodeFile="HRPerfCheck.aspx.cs" Inherits="HRPerfMgt_HRPerfCheck" %>
                ...
                <fieldset>
                    ...
                    <table style="width: 100%;">
                        <tr style="height: 16px;">
                            <td style="width: 10%" align="center">
                                <asp:Label ID="Label1" runat="server" CssClass="STYLE2" Text="考核类型：" Enabled="False"></asp:Label>
                                ...
                                <fieldset>
                                    ...
                                    <asp:GridView ID="Grid_Detail" runat="server" DataKeyNames="HRPD_ID" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UMUI_UserName" HeaderText="考核人" SortExpression="UMUI_UserName">
                                                <ItemStyle />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="HRPD_Atime" HeaderText="考核时间" SortExpression="HRPD_Atime">
                                                <ItemStyle />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="HRPD_FinalScore" HeaderText="审核前得分" SortExpression="HRPD_FinalScore">
                                                <ItemStyle />
                                            </asp:BoundField>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnEdit1" runat="server" CommandArgument='<%#Eval("HRPD_ID")%>'
                                                        CommandName="Edit1" OnClientClick="false">审核考核信息</asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle />
                                            </asp:TemplateField>
                                        </Columns>
                ...
                <fieldset>
                    ...
                    <table style="width: 100%;">
                       ...
                       <tr style="height: 16px;">
                            <td></td>
                            <td align="right">
                                <asp:Label ID="LblSPerson" runat="server"  Text="审核人："></asp:Label>
                            </td>
                            <td  align="left">
                                <asp:TextBox ID="CheckPerson" runat="server" Width="120px" Enabled="false" MaxLength="10"></asp:TextBox>
                            </td>
                            <td  align="right">
                    ...
                    <asp:GridView ID="GridView2" runat="server" AllowSorting="True" DataKeyNames="HRPIS_ItemID"
                                        AutoGenerateColumns="False" CssClass="GridViewStyle" Width="100%" AllowPaging="True"
                                        GridLines="None" OnRowCommand="Grid_Detail_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging"
                        ...
                        <Columns>
                            <asp:BoundField DataField="HRPIS_ItemID" HeaderText="考核项目分值ID"  SortExpression="HRPIS_ItemID">
                            ...
                            <asp:BoundField DataField="HRPIS_ItemScore" HeaderText="审核前得分" SortExpression="HRPIS_ItemScore">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="该项目最终得分">
                              <ItemTemplate>
                                 <asp:TextBox ID="TxtRemarks" runat="server" Width="100%" MaxLength="2"
                                 onkeyup="this.value=this.value.replace(/[^\d{1,2}]/g,'')" onafterpaste="this.value=this.value.replace(/[^\d{1,2}]/g,'')"></asp:TextBox>
                              </ItemTemplate>
                                <ItemStyle />                                                     
                            </asp:TemplateField>                                                                          
                                ...
                                <fieldset>
                                    ...
                                    <asp:GridView ID="GridView3" runat="server" DataKeyNames="HRPD_ID" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="HRPD_State" HeaderText="审核状态" SortExpression="HRPD_State">
                                                <ItemStyle />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="HRPD_C_FinalScore" HeaderText="审核成绩" SortExpression="HRPD_C_FinalScore">
                                                <ItemStyle />
                                            </asp:BoundField>

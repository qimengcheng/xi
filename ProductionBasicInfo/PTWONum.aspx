<%@ Page Title="" Language="C#" MasterPageFile="~/Other/MasterPage.master" AutoEventWireup="true"
    CodeFile="PTWONum.aspx.cs" Inherits="ProductionBasicInfo_PTWONum" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel_PS" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="Panel2" runat="server" Visible="true">
                <fieldset>
                    <legend>随工单产品代码表<asp:Label ID="Lab_State" runat="server" Visible="False"></asp:Label>
                    </legend>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle"
                        ...
                        Width="100%" DataKeyNames="WOC_ID" OnDataBound="GridView1_DataBound">
                        ...
                        <Columns>
                            <asp:BoundField DataField="WOC_ID" HeaderText="随工单产品代码ID" SortExpression="WOC_ID" Visible="false">
                            </asp:BoundField>
                            <asp:BoundField DataField="WOC_Name" SortExpression="WOC_Name" HeaderText="随工单产品代码"></asp:BoundField>
                            <asp:CommandField ShowEditButton="True" EditText="编辑" UpdateText="更新" CancelText="关闭">
                                <ItemStyle />
                            </asp:CommandField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="Delete1" runat="server" CommandArgument='<%# Eval("WOC_ID") %>'
                                        CommandName="Delete1" OnClientClick="return confirm('您确认删除该记录吗?')">删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="CheckProType" runat="server" CommandArgument='<%# Eval("WOC_ID")+","+Eval("WOC_Name") %>'
                ...
                <fieldset>
                    ...
                    <table style="width: 100%;">
                        <tr style="width: 100%;">
                            ...
                            <td style="width: 25%;">
                                <asp:TextBox ID="txt_PS" runat="server" Width="150px" MaxLength="2" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" 
                                onafterpaste="value=value.replace(/[^\w\.\/]/ig,'')"></asp:TextBox>

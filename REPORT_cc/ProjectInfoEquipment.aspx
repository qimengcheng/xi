<%@ Page Title="" Language="C#" MasterPageFile="~/Other/MasterPage.master" AutoEventWireup="true" CodeFile="ProjectInfoEquipment.aspx.cs" Inherits="Laputa_ProjectInfoEquipment" %>
        ...
        <ContentTemplate>
         ...
         <fieldset><legend>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" CssClass="GridViewStyle"  EmptyDataText="没有相关记录，请搜索。" GridLines="None" OnPageIndexChanging="GridView2_PageIndexChanging" PageSize="15" EnableModelValidation="True" AutoGenerateColumns="False" OnRowDataBound="GridView2_RowDataBound">
                ...
                <HeaderStyle CssClass="GridViewHead" />
                <Columns>
                      <asp:BoundField DataField="EI_ID_SheBei" HeaderText="设备ID" >
                      <HeaderStyle CssClass="hide" />
                      <ItemStyle CssClass="hide" />
                      </asp:BoundField>
                    <asp:BoundField DataField="工序名称" HeaderText="工序名称" />
                    <asp:BoundField DataField="设备名称" HeaderText="设备名称" />
                    <asp:BoundField DataField="设备编号" HeaderText="设备编号" />
                      <asp:BoundField DataField="模具名称" HeaderText="模具名称" />
                    <asp:BoundField DataField="模具编号" HeaderText="模具编号" />
                    <asp:BoundField DataField="入站数" HeaderText="入站数" />
                    <asp:BoundField DataField="出站数" HeaderText="出站数" />
                    <asp:BoundField DataField="合格率" HeaderText="合格率" />
                ...
                <FooterStyle CssClass="GridViewFooterStyle" />
                    ...
                    <asp:BoundField DataField="不良品数" HeaderText="不良品数" />
                </Columns>
                <FooterStyle CssClass="GridViewFooterStyle" />
                <PagerTemplate>
                    <table width="100%">

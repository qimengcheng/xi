<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipMaintenanceTotalPrint.aspx.cs" Inherits="REPORT_cc_EquipMaintenanceTotalPrint"  Title="设备故障停机统计总表打印"  EnableEventValidation="false"%>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 设备故障停机统计总表" Font-Size="25px"></asp:Label>
    </p>
                ...
                <tr>
                    <td >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Amount" HeaderText="设备台数" SortExpression="Amount">
                                <ItemStyle />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="MaintenanceAvgTime" HeaderText="故障维修均时(H)" SortExpression="MaintenanceAvgTime">
                                <ItemStyle />
                            </asp:BoundField>
                            ...
                            <asp:BoundField HeaderText="原因">
                                <ItemStyle Width="15%"/>
                            </asp:BoundField>
                            <asp:BoundField HeaderText="整改措施">
                                <ItemStyle Width="15%"/>
                            </asp:BoundField>
                        </Columns>
                        <EmptyDataTemplate>

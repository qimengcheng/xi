...
public partial class Laputa_SunMasterTypeMonthTrendsSeriesPrint: Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        GridView2.DataSource = lpp.Query_SunMasterMonthSeries(DropDownList1.Text);
        GridView2.DataBind();
        Panel3.Visible = true;
    ...
    {
        Response.Redirect("~/report_cc/SunMasterTypeMonthTrendsSeries.aspx");
    }

...
public partial class REPORT_cc_PersonnelSalaryRecord : System.Web.UI.Page
{
    ...
    protected string GetCondition()
    {
        ...
        {
            temp += " and HRSR_ChargePer like '%" + this.textper.Text.Trim() + "%'";
        }
        ...
        {
            temp += " and HRSR_Time >= '" + laststar.Text.Trim() + "' and HRSR_Time <= '" + lastend.Text.Trim() + "'";
        }
        if (this.laststar.Text.ToString() != "" && this.lastend.Text.ToString() == "")
        {
            temp += " and HRSR_Time >= '" + laststar.Text.Trim() + "'";
        }
        if (this.laststar.Text.ToString() == "" && this.lastend.Text.ToString() != "")
        {
            temp += " and HRSR_Time <= '" + lastend.Text.Trim() + "'";
        }
        if (this.laststar.Text.ToString() == "" && this.lastend.Text.ToString() == "")
        {
            temp += "";
    ...
    {
        Response.Redirect("../REPORT_cc/PersonnelSalaryRecordPrint.aspx?" + "&HRDD_StaffNO=" + textno.Text.ToString() + "&HRDD_Name=" + textname.Text.ToString() + "&HRSR_ChargePer=" + textper.Text.ToString() + "&startime=" + laststar.Text + "&endtime=" + lastend.Text + "&BDOS_Name=" + TextBox1.Text.ToString() + "&HRP_Post=" + TextBox2.Text.ToString());
    }
    //Grid_Detail翻页

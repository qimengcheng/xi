...
public partial class Laputa_SunMasterTypeYearTrends : System.Web.UI.Page
{
    ...
    protected void SearchInStoreMain(object sender, EventArgs e)
    {
        ...
        GridView2.DataSource = lpp.Query_SunMasterYear(DropDownList1.SelectedValue);
        GridView2.DataBind();
        Panel3.Visible = true;
    }
    ...
    protected void print(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/report_cc/SunMasterTypeYearTrendsPrint.aspx?year="+DropDownList1.SelectedValue);
    }

...
public partial class REPORT_cc_TimePerDayDetail : System.Web.UI.Page
{
    ...
    protected void Button2_Click1(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../REPORT_cc/TimePerDayDetailPrint.aspx?" + "&Time1=" + this.startime.Text + "&Time2=" + this.endtime.Text + "&Getcondition()=" + GetCondition());
        }
    }
}
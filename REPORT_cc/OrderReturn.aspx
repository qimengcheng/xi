<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderReturn.aspx.cs" Inherits="PurchasingMgt_OrderReturn"   MasterPageFile="~/Other/MasterPage.master"%>
    ...
    <table style="width: 100%;">
     ...
     <tr>
          <td align="right" class="auto-style12">
                ...
                <asp:Label ID="Label1" runat="server" Text="退货日期："></asp:Label>

<%@ Page Title="不同规格不良品统计表" Language="C#" MasterPageFile="~/Other/MasterPage.master" AutoEventWireup="true" CodeFile="WIP_BadPro_BigType.aspx.cs" Inherits="REPORT_cc_WIP_BadPro_BigType" EnableEventValidation="false"%>
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel_Search" runat="server">
                <fieldset>
                    ...
                    <tr style="height: 16px;">
                            <td style="width: 13%; height: 15px;" align="center">
                                <asp:Label ID="Label1" runat="server" Text="大类型号："></asp:Label>
                            </td>
                            <td style="width: 20%; height: 15px;">

<%@ Page Title="设备产量统计表" MasterPageFile="~/Other/MasterPage.master" Language="C#" AutoEventWireup="true" CodeFile="EquipOutput.aspx.cs" Inherits="REPORT_cc_EquipOutput" %>
...
<asp:UpdatePanel ID="UpdatePanel_Grid" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="Panel_Grid" runat="server">
                <fieldset>
                    <legend>设备产量统计表</legend>
                    <asp:Label ID="label22" runat="server" Text="注：利用率1=实际产量/满理论产量；利用率2=实际产量/理论产量" ForeColor="Gray"></asp:Label>
                    <asp:GridView ID="Grid_Detail" runat="server" AllowSorting="True" PageSize="20" AutoGenerateColumns="False" CssClass="GridViewStyle" Width="100%" 
                        ...
                        <asp:TemplateField HeaderText="序号">
                            ...
                            <asp:BoundField DataField="EN_Output" HeaderText="小时理论产量(K)" SortExpression="EN_Output">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="EN_WorkTime" HeaderText="月工作全时间(H)" SortExpression="EN_WorkTime">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="BreakDownTime" HeaderText="月故障停机时间(H)" SortExpression="BreakDownTime">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="FullTheoryOutput" HeaderText="满理论产量(K)" SortExpression="FullTheoryOutput">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="TheoryOutput" HeaderText="理论产量(K)" SortExpression="TheoryOutput">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="ActOutput" HeaderText="实际产量(K)" SortExpression="ActOutput">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="FullTheoryPercent" HeaderText="利用率1(%)" SortExpression="FullTheoryPercent">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="TheoryPercent" HeaderText="利用率2(%)" SortExpression="TheoryPercent">
                                <ItemStyle />
                            </asp:BoundField>
                        </Columns>
                        <PagerTemplate>

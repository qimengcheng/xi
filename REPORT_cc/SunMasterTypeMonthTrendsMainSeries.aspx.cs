...
public partial class Laputa_SunMasterTypeMonthTrendsMainSeries : System.Web.UI.Page
{
    ...
    protected void SearchInStoreMain(object sender, EventArgs e)
    {
        ...
        GridView2.DataSource = lpp.Query_SunMasterMonthMainSeries(DropDownList1.SelectedValue);
        GridView2.DataBind();
        Panel3.Visible = true;
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Gra")
        {
            ...
            DataSet ds = lpp.Query_SunMasterMonthMainSeries(DropDownList1.SelectedValue);
    ...
    protected void print(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/report_cc/SunMasterTypeMonthTrendsMainSeriesPrint.aspx?month="+DropDownList1.SelectedValue);
    }

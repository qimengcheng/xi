<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="TrainingEachMonthAnalysisPrint.aspx.cs" Inherits="PurchasingMgt_TrainingEachMonthAnalysisPrint" %>
...
<body id="Body1" style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 —培训月报表" Font-Size="25px"></asp:Label>

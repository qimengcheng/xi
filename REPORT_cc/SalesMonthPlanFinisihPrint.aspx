<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeFile="SalesMonthPlanFinisihPrint.aspx.cs" Inherits="PurchasingMgt_SalesMonthPlanFinisihPrint" %>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 每月销售计划完成情况统计表" Font-Size="25px"></asp:Label>
            ...
            <table border="0" cellspacing="1" width="100%" style="text-align: center">
                ...
                <tr>
                    <td >
                        ...
                        <asp:BoundField DataField="SMSMPD_PlanAmount" HeaderText="月计划总量" SortExpression="SMSMPD_PlanAmount">
                         
                        </asp:BoundField>
                        <asp:BoundField DataField="SMSOD_Mount" HeaderText="当月订单数量" SortExpression="SMSOD_Mount">
                        </asp:BoundField>
                         <asp:BoundField DataField="OnProductionNum" HeaderText="及时在制品数量" SortExpression="OnProductionNumt">
                        </asp:BoundField>
                        <asp:BoundField DataField="SMSWPD_Storge" HeaderText="及时库存数量" SortExpression="SMSWPD_Storge"/>
                        <asp:BoundField DataField="ActualArrNum" HeaderText="当月入库数量" SortExpression="ActualArrNum"/>
                        <asp:BoundField DataField="SMSMPD__ActualNum" HeaderText="当月发货数量" SortExpression="SMSMPD__ActualNum"/>

...
public partial class Laputa_ProjectInfoEquipment : System.Web.UI.Page
{
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                SqlDataReader reader = lpp.Query_ProjectReportEquipmentBad(new Guid(e.Row.Cells[0].Text),
                    e.Row.Cells[5].Text, e.Row.Cells[1].Text.Replace("&amp;", "&"), Convert.ToDateTime(TextBox5.Text),
                    Convert.ToDateTime(TextBox6.Text));

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup ="true" CodeFile="WOError_StatisticsPrint.aspx.cs" Inherits="PurchasingMgt_WOError_StatisticsPrint" %>
...
<body id="Body1" style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 —异常统计表" Font-Size="25px"></asp:Label>

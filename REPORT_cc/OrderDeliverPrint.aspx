<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="OrderDeliverPrint.aspx.cs" Inherits="PurchasingMgt_OrderDeliverPrint" %>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 —销售发货单" Font-Size="25px"></asp:Label>

<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TakeInventoryPrint.aspx.cs" Inherits="REPORT_cc_TakeInventoryPrint" %>
...
<body id="Body1" style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 —财务部在制品盘存统计表" Font-Size="25px"></asp:Label>

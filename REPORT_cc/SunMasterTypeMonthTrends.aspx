<%@ Page Title="" Language="C#" MasterPageFile="~/Other/MasterPage.master" AutoEventWireup="true" CodeFile="SunMasterTypeMonthTrends.aspx.cs" Inherits="Laputa_SunMasterTypeMonthTrends" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
            ...
            <asp:Panel ID="Panel_Search" runat="server" Visible="true" >
                <fieldset>
                    <legend>产品合格率(按塑封桥、浇灌桥和模块事业部统计)</legend>

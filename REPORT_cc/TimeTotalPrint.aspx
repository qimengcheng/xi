<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="TimeTotalPrint.aspx.cs" Inherits="REPORT_cc_TimeTotalPrint" %>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 计时信息阶段统计表" Font-Size="25px"></asp:Label>

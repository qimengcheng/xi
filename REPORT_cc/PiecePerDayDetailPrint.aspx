<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="PiecePerDayDetailPrint.aspx.cs" Inherits="REPORT_cc_PiecePerDayDetailPrint" %>
...
<body id="Body1" style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 —计件信息详情表" Font-Size="25px"></asp:Label>
         </p>
                ...
                <tr>
                    <td >
                        ...
                        <asp:TemplateField HeaderText="序号">
                            ...
                            <asp:BoundField DataField="thedate" HeaderText="时间" SortExpression="thedate">
                                <ItemStyle />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="thenum" HeaderText="数量" SortExpression="thenum">
                                <ItemStyle />
                            </asp:BoundField>

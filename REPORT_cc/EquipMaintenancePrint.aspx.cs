...
public partial class REPORT_cc_EquipMaintenancePrint : Page
{
    ...
    {
        Response.Redirect("~/REPORT_cc/EquipMaintenance.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        ExcelHelper.GridViewToExcel(Grid_Detail, "设备台账故障停机统计表");
    }

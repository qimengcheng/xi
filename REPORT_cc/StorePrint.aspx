<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorePrint.aspx.cs" Inherits="Laputa_StorePrint" 
    ...
    <div>
        ...
        <div>
         ...
         <fieldset><legend>
            ...
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="GridViewStyle"  EmptyDataText="没有相关记录，请搜索。" GridLines="None" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowCommand="GridView2_RowCommand" PageSize="15" EnableModelValidation="True">
                <RowStyle CssClass="GridViewRowStyle" />
                <SelectedRowStyle CssClass="GridViewSelectedRowStyle" />
                <AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" />
                <HeaderStyle CssClass="GridViewHead" />
                ...
                <Columns>
                            ...
                            <asp:BoundField DataField="storetime" HeaderText="时间" DataFormatString="{0:yyyy-MM-dd }" />
                            <asp:BoundField DataField="storeway" HeaderText="类型" />
                            <asp:BoundField DataField="batchnum" HeaderText="批号" />
                            <asp:BoundField DataField="IMMBD_MaterialName" HeaderText="材料名称" Visible="true" SortExpression="SMSMPM_Year" />
                            <asp:BoundField DataField="IMMBD_SpecificationModel" HeaderText="材料型号" Visible="true" SortExpression="SMSMPM_Month" />

                            <asp:BoundField DataField="company" HeaderText="企业名称" />
                            <asp:BoundField DataField="UnitName" HeaderText="单位" />
                            <asp:BoundField DataField="man" HeaderText="操作人" />
                            <asp:BoundField DataField="totalnum" HeaderText="累积余额" />
                </Columns>
                <PagerTemplate>
                    <table width="100%">
                        <tr>

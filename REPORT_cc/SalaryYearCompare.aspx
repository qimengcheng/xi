<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryYearCompare.aspx.cs" Inherits="PurchasingMgt_SalaryYearCompare"   MasterPageFile="~/Other/MasterPage.master"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:Panel ID="Panel_OASearch" runat="server" Visible="true">
                <fieldset>
                    <legend> 年度薪资对比查询
                      ...
                      <asp:Label ID="label_condition" runat="server" Visible="false" />
    <table style="width: 100%;">
         ...
         <td class="auto-style9">
                <asp:DropDownList ID="DropDownList_Year" runat="server" Height="22px" Width="127px" OnSelectedIndexChanged="DropDownList_Year_SelectedIndexChanged" AutoPostBack="True">
                                </asp:DropDownList>
            </td>
               
                 <td align="right" style="width: 15%;">
                <asp:Label ID="label_Num" runat="server" Visible="true" Text="所选年份(可多选)："/>
             ...
             <AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" />
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SDBT_Year" HeaderText="年份" 
                         ...
                         <asp:BoundField DataField="总工时" HeaderText="总工时" SortExpression="总工时">
                        </asp:BoundField>
                         <asp:BoundField DataField="总额" HeaderText="总额" SortExpression="总额">
                        </asp:BoundField>
                         <asp:BoundField DataField="总人数" HeaderText="总人数" SortExpression="总人数">
                        </asp:BoundField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TimeChagePrint.aspx.cs" Inherits="REPORT_cc_TimeChagePrint" Title="计时工价变动表打印" EnableEventValidation="false"%>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 计时工价变动表" Font-Size="25px"></asp:Label>
    </p>
    <div style="text-align: left;">
            <table border="0" cellspacing="1" width="100%" style="text-align: center">
                <tr>
                    <td align="center" valign="top">
                        <asp:Label ID="Label1" runat="server" Text="执行时间：" Font-Size="15px"></asp:Label>
                        &nbsp;
                ...
                <tr>
                    <td >
                        ...
                        <asp:BoundField DataField="STI_Name" SortExpression="STI_Name">
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField DataField="now" SortExpression="now">
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField DataField="STICR_FormerPrice" SortExpression="STICR_FormerPrice">
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField DataField="STICR_NewPrice" SortExpression="STICR_NewPrice">
                            <ItemStyle />
                        </asp:BoundField>

<%@ Page Title="人事调薪报表" MasterPageFile="~/Other/MasterPage.master" Language="C#" AutoEventWireup="true" CodeFile="PersonnelSalaryRecord.aspx.cs" Inherits="REPORT_cc_PersonnelSalaryRecord" %>
                ...
                <fieldset>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 10%" align="center">
                                <asp:Label ID="Label2" runat="server" Text="调薪负责人："></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="width: 13%; height: 15px;" align="center">
                                <asp:Label ID="Label3" runat="server" Text="调薪日期："></asp:Label>
                            </td>
                            <td style="width: 20%; height: 15px;">

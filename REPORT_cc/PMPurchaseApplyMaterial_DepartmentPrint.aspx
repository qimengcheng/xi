<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="PMPurchaseApplyMaterial_DepartmentPrint.aspx.cs" Inherits="PurchasingMgt_PMPurchaseApplyMaterial_DepartmentPrint" Title="采购申请物料数量汇总统计表打印" %>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 采购申请物料数量汇总统计表" Font-Size="25px"></asp:Label>
    </p>

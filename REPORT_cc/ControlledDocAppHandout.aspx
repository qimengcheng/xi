<%@ Page Title="受控文件分发一览表" Language="C#" MasterPageFile="~/Other/MasterPage.master"
    AutoEventWireup="true" CodeFile="ControlledDocAppHandout.aspx.cs" Inherits="REPORT_cc_ControlledDocAppHandout" %>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 10%; height: 15px;" align="center">
                                <asp:Label ID="Label1" runat="server" Text="分发部门："></asp:Label>
                            </td>
                        ...
                        <tr style="height: 16px;">
                            ...
                            <td style="width: 20%; height: 15px;">
                                <asp:TextBox ID="texteditno" runat="server" Width="155px"></asp:TextBox>
                            </td>
                            <td style="width: 10%" align="center">
                                    <asp:Label ID="Label111" runat="server" Text="生效时间："></asp:Label>
                                </td>
                                </td>
                                <td>
                ...
                <fieldset>
                    ...
                    <asp:GridView ID="Grid_Detail" runat="server" AllowSorting="True" PageSize="20" AutoGenerateColumns="False" CssClass="GridViewStyle" Width="100%" 
                        ...
                        <asp:TemplateField HeaderText="序号">
                            ...
                            <asp:BoundField DataField="CDA_EditionNO" HeaderText="版本号" SortExpression="CDA_EditionNO">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="CDA_EffectDate" HeaderText="生效时间" SortExpression="CDA_EffectDate">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="AllDep" HeaderText="分发部门" SortExpression="AllDep">
                                <ItemStyle />
                            </asp:BoundField>
                        </Columns>
                        <PagerTemplate>

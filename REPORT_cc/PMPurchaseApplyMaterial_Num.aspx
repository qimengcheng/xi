<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PMPurchaseApplyMaterial_Num.aspx.cs" Inherits="PurchasingMgt_PMPurchaseApplyMaterial_Num"  MasterPageFile="~/Other/MasterPage.master"  %>
        ...
        <tr>
           ...
           <td align="right" class="auto-style15">
             ...
             <td align="right" class="auto-style13">
               ...
               <asp:Label ID="Label3" runat="server" Text="申请部门："></asp:Label>
            ...
            <tr>
             ...
             <td align="center" colspan="1" class="auto-style13">
                ...
                <asp:Label ID="label_Title" runat="server" Visible="false" />
                 ...
                 <%--onrowdatabound="Gridview_OAInfo_RowDataBound"--%>
                  <asp:GridView ID="Gridview_OAInfo"  runat="server" AutoGenerateColumns="False"
                    ...
                    EnableModelValidation="True" ShowFooter="true" OnRowDataBound="Gridview_OAInfo_RowDataBound"
                   >

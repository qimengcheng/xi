...
public partial class Laputa_StorePrint : Page
{
    private readonly LaputaPrintPoolD lpp = new LaputaPrintPoolD();

    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["mid"] == null || Request.QueryString["stime"] == null || Request.QueryString["etime"] == null)
        {
            ScriptManager.RegisterStartupScript(this.Page, typeof (Page), "alert", "alert('数据获取异常');", true);
        }
        else
        {
            mid.Text = Request.QueryString["mid"];
    ...
    protected void ToExcel_Click(object sender, EventArgs e)
    {
        ...
        Bindgrid2();
        ExcelHelper.GridViewToExcel(GridView2, TextBox5.Text + "至" + TextBox6.Text + Label3.Text + "明细账");
    }
    ...
    {
        Response.Redirect("~/report_cc/Store.aspx");
    }
}
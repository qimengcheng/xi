<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PersonnelSalaryRecordPrint.aspx.cs" Inherits="REPORT_cc_PersonnelSalaryRecordPrint" Title="人事调薪报表打印" EnableEventValidation="false"%>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 人事调薪报表" Font-Size="25px"></asp:Label>
    </p>
    <div style="text-align: left;">
            <table border="0" cellspacing="1" width="100%" style="text-align: center">
                ...
                <tr>
                    <td >
                        <asp:GridView ID="Grid_Detail" runat="server" CssClass="GridViewStyle" Width="100%" AutoGenerateColumns="False" GridLines="None" onrowcreated="Grid_Detail_RowCreated">
                        ...
                        <asp:BoundField DataField="HRSR_Time" HeaderText="调薪日期" SortExpression="HRSR_Time">
                            <ItemStyle />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="former" SortExpression="former">
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField DataField="now" SortExpression="now">
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField DataField="jine" SortExpression="jine">
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField DataField="fudu" SortExpression="fudu">
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField DataField="HRSR_ChargePer" SortExpression="HRSR_ChargePer">
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField DataField="HRSR_Reason" SortExpression="HRSR_Reason">
                            <ItemStyle />
                        </asp:BoundField>
                        </Columns>
                        <EmptyDataTemplate>

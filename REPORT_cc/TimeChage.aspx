<%@ Page Title="计时工价变动表" MasterPageFile="~/Other/MasterPage.master" Language="C#" AutoEventWireup="true" CodeFile="TimeChage.aspx.cs" Inherits="REPORT_cc_TimeChage" %>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 10%" align="center">
                                <asp:Label ID="Label2" runat="server" Text="计时项目："></asp:Label>
                            </td>
                            <td>

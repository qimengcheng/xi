...
public partial class Laputa_SunMasterTypeMonthTrendsMainSeriesPrint: Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            DropDownList1.Text = Request.QueryString["month"];
            Label6.Text = Request.QueryString["month"];
        }
        try
        {
        ...
        GridView2.DataSource = lpp.Query_SunMasterMonthMainSeries(DropDownList1.Text);
        GridView2.DataBind();
        Panel3.Visible = true;
    ...
    {
        Response.Redirect("~/report_cc/SunMasterTypeMonthTrendsMainSeries.aspx");
    }

<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="ReturnPayPlanPrint.aspx.cs" Inherits="PurchasingMgt_ReturnPayPlanPrint" %>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 回款计划" Font-Size="25px"></asp:Label>

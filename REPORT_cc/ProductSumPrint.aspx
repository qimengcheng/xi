<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductSumPrint.aspx.cs" Inherits="REPORT_cc_ProductSumPrint" Title="产品流量统计打印" EnableEventValidation="false"%>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 产品流量统计" Font-Size="25px"></asp:Label>
    </p>
                ...
                <tr>
                    <td >
                        ...
                        <asp:TemplateField HeaderText="序号">
                            ...
                            <asp:BoundField DataField="xiaoshou" HeaderText="发货数" SortExpression="xiaoshou">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="suigongdan" HeaderText="投产数量" SortExpression="suigongdan">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="ruku" HeaderText="入库数" SortExpression="ruku">
                                <ItemStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="IMIM_TotalNum" HeaderText="库存及时数量" SortExpression="IMIM_TotalNum">
                                <ItemStyle />
                            </asp:BoundField>
                        </Columns>
                        <EmptyDataTemplate>

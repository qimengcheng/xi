<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="SalaryEachMonthAnalysisPrint.aspx.cs" Inherits="PurchasingMgt_SalaryEachMonthAnalysisPrint" %>
...
<body id="Body1" style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 —月度薪资分析表" Font-Size="25px"></asp:Label>

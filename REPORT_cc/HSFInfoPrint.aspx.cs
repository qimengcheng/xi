...
public partial class Laputa_HSFInfoPrint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
                TextBox22.Text = Request.QueryString["name"];
                TextBox23.Text = Request.QueryString["provider"];
    ...
    protected void ROHS_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            SqlDataReader reader = lpp.Query_HSFInfoNet(new Guid(GridView2.DataKeys[main.RowIndex].Value.ToString()), "ROHS");
            var dt = new DataTable();
            int i = 0;
            DataRow dr = dt.NewRow();
            while (reader.Read())
    ...
    protected void REACH_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            GridViewRow main = e.Row.Parent.Parent.Parent.Parent as GridViewRow;
            SqlDataReader reader = lpp.Query_HSFInfoNet(new Guid(GridView2.DataKeys[main.RowIndex].Value.ToString()), "reach");
            var dt = new DataTable();
            int i = 0;
            DataRow dr = dt.NewRow();
            while (reader.Read())
    ...
    protected void CL_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            GridViewRow main = e.Row.Parent.Parent.Parent.Parent as GridViewRow;
            SqlDataReader reader = lpp.Query_HSFInfoNet(new Guid(GridView2.DataKeys[main.RowIndex].Value.ToString()), "卤素");
            var dt = new DataTable();
            int i = 0;
            DataRow dr = dt.NewRow();
            while (reader.Read())
    ...
    protected void BR_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            GridViewRow main = e.Row.Parent.Parent.Parent.Parent as GridViewRow;
            SqlDataReader reader = lpp.Query_HSFInfoNet(new Guid(GridView2.DataKeys[main.RowIndex].Value.ToString()), "六溴环十二烷");
            var dt = new DataTable();
            int i = 0;
            DataRow dr = dt.NewRow();
            while (reader.Read())
    ...
    protected void C_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            GridViewRow main = e.Row.Parent.Parent.Parent.Parent as GridViewRow;
            SqlDataReader reader = lpp.Query_HSFInfoNet(new Guid(GridView2.DataKeys[main.RowIndex].Value.ToString()), "鄰苯二甲酸酯类");
            var dt = new DataTable();
            int i = 0;
            DataRow dr = dt.NewRow();
            while (reader.Read())
    ...
    protected void ToExcel_Click(object sender, EventArgs e)
    {
        ...
        Bindgrid2();
        ExcelHelper.GridViewToExcel(GridView2, "有毒物质统计报表");
    }
    protected void back_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/report_cc/HSFInfo.aspx");
    }
}
...
public partial class Laputa_SunMasterTypeMonthTrends : System.Web.UI.Page
{
    ...
    protected void SearchInStoreMain(object sender, EventArgs e)
    {
        ...
        GridView2.DataSource = lpp.Query_SunMasterMonth(DropDownList1.SelectedValue);
        GridView2.DataBind();
        Panel3.Visible = true;
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Gra")
        {
            ...
            //ds.Tables[0].Select();
            //Chart1.DataSource = ds.Tables[0].Select("年份="+DateTime.Now.Year+  "and 大型号='"+e.CommandArgument+"'");
    ...
    protected void print(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/report_cc/SunMasterTypeMonthTrendsPrint.aspx?month="+DropDownList1.SelectedValue);
    }

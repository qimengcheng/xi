...
public partial class Laputa_SunMasterType : System.Web.UI.Page
{
    ...
    protected void SearchInStoreMain(object sender, EventArgs e)
    {
        ...
        GridView2.DataSource = lpp.Query_SunMasterType(Convert.ToDateTime(TextBox5.Text),
    ...
    protected void print(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/report_cc/SunMasterTypePrint.aspx?stime=" + TextBox5.Text + "&etime=" +
                          TextBox6.Text);
    }
    ...
    protected void Chart1_Load(object sender, EventArgs e)
    {
        ...
        //设置图表的数据源
        //Chart1.DataSource = lpp.Query_SunMasterType(Convert.ToDateTime(TextBox5.Text),
        //     Convert.ToDateTime(TextBox6.Text));
        ...
        //Chart1.Series[0].YValueMembers = "产品型号";
        //Chart1.Series[1].YValueMembers = "合格率";

        ////设置图表X轴对应项
        //Chart1.Series[0].XValueMember = "产品型号";
        //Chart1.Series[1].XValueMember = "产品型号";

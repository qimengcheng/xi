...
public partial class REPORT_cc_TimeChage : System.Web.UI.Page
{
    ...
    protected string GetCondition()
    {
        ...
        {
            temp += " and STI_Name like '%" + this.textxiangmu.Text.Trim() + "%'";
        }
        //时间
        if (this.laststar.Text.ToString() != "" && this.lastend.Text.ToString() != "")
        {
            temp += " and STICR_ExecDate >= '" + laststar.Text.Trim() + "' and STICR_ExecDate <= '" + lastend.Text.Trim() + "'";
        }
        if (this.laststar.Text.ToString() != "" && this.lastend.Text.ToString() == "")
        {
            temp += " and STICR_ExecDate >= '" + laststar.Text.Trim() + "'";
        }
        if (this.laststar.Text.ToString() == "" && this.lastend.Text.ToString() != "")
        {
            temp += " and STICR_ExecDate <= '" + lastend.Text.Trim() + "'";
        }
        if (this.laststar.Text.ToString() == "" && this.lastend.Text.ToString() == "")
        {
            temp += "";
    ...
    {
        Response.Redirect("../REPORT_cc/TimeChagePrint.aspx?" + "&PBC_Name=" + textgongxu.Text.ToString() + "&STI_Name=" + textxiangmu.Text.ToString() + "&startime=" + laststar.Text + "&endtime=" + lastend.Text);
    }
    //Grid_Detail翻页

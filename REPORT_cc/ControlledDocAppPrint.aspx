<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ControlledDocAppPrint.aspx.cs" Inherits="REPORT_cc_ControlledDocAppPrint" Title="各部门受控文件一览表打印" EnableEventValidation="false"%>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 各部门受控文件一览表" Font-Size="25px"></asp:Label>
    </p>
    <div style="text-align: left;">
            <table border="0" cellspacing="1" width="100%" style="text-align: center">
                <tr>
                    <td align="center" valign="top">
                        <asp:Label ID="Label1" runat="server" Text="部门：" Font-Size="15px"></asp:Label>
                        &nbsp;
                        <asp:Label ID="AppDep" runat="server" Text="AppDep" Font-Size="15px"></asp:Label>
                    </td>
                </tr>
                <tr>

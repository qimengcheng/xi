<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeFile="OfficeAppliancePrint.aspx.cs" Inherits="PurchasingMgt_OfficeAppliancePrint" %>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 办公用品申请汇总统计表" Font-Size="25px"></asp:Label>

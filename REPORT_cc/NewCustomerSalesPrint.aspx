<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeFile="NewCustomerSalesPrint.aspx.cs" Inherits="PurchasingMgt_NewCustomerSalesPrint" %>
...
<body id="Body1" style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 —新客户销售额汇总表" Font-Size="25px"></asp:Label>
            ...
            <table border="0" cellspacing="1" width="100%" style="text-align: center">
                <tr>
                    <td align="center" valign="top">
                        ...
                        &nbsp;
                        <asp:Label ID="Labelstart" runat="server" Text="Labelstart" Font-Size="15px" Visible="true"></asp:Label>
                        &nbsp;

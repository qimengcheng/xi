...
public partial class REPORT_cc_WIP_BadPro_BigType : System.Web.UI.Page
{
    ...
    protected void BindDropDownList2()
    {
        ...
        DropDownList2.DataValueField = "PMS_ID";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "alert", "alert('请选择工序、大类型号以及统计起止时间！')", true);
            return;
        }
        ...
        DataSet ds = sd.S_WIP_BadPro_BigType(date1, date2,sj,sx);
        DataTable dt = ds.Tables[0];
        //ExcelHelper.ExportResult(ds, "生产工序产量汇总表(" + DropDownList1.SelectedItem.Text + startime.Text + "至" + endtime.Text + ")");
        ExportResult(dt, "不同规格不良品统计表(" + DropDownList2.SelectedItem.Text + DropDownList1.SelectedItem.Text + startime.Text + "至" + endtime.Text + ")");
    }

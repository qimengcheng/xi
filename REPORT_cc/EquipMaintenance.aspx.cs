...
public partial class REPORT_cc_EquipMaintenance : Page
{
    ...
    protected string GetCondition1()
    {
        ...
        //{
        //    temp += " and ((EMA_CheckTime >= '" + startime.Text.Trim() + "' and EMA_CheckTime <= '" + endtime.Text.Trim() + "') or EMA_CheckTime is null) and ((ERDAOA_EndTime >= '" + startime.Text.Trim() + "' and ERDAOA_EndTime <= '" + endtime.Text.Trim() + "') or ERDAOA_EndTime is null)";
        //}
        condition1 = temp;
        return condition1;
    }
    ...
    protected void BtnPrint_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../REPORT_cc/EquipMaintenancePrint.aspx?" + "&EI_No=" + textno.Text.ToString() + "&EN_EquipName=" + textname.Text + "&EMT_Type=" + texttype.Text + "&startime=" + startime.Text + "&endtime=" + endtime.Text);
    }
    //Grid_Detail翻页

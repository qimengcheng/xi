...
public partial class Laputa_ProjectInfoProMainSeries : System.Web.UI.Page
{
    ...
    protected void SearchInStoreMain(object sender, EventArgs e)
    {
        ...
        GridView2.DataSource = lpp.Query_ProjectInfoProMainSeries(Convert.ToDateTime(TextBox5.Text),
    ...
    protected void print(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/report_cc/ProjectInfoProMainSeriesPrint.aspx?stime=" + TextBox5.Text + "&etime=" +
                          TextBox6.Text);
    }

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="RightTimeSMPrint.aspx.cs" Inherits="PurchasingMgt_RightTimeSMPrint" %>
...
<body id="Body1" style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 —订单库存在制品一览表" Font-Size="25px"></asp:Label>
    ...
    <div style="text-align: left;">
       ...
       <br/>
         <asp:Button ID="Button4" runat="server" CssClass="Button02" OnClick="Button_Excel2"

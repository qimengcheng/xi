<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipMaintenancePrint.aspx.cs" Inherits="REPORT_cc_EquipMaintenancePrint"  Title="设备台账故障停机统计表打印"  EnableEventValidation="false"%>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 设备台账故障停机统计表" Font-Size="25px"></asp:Label>
    </p>

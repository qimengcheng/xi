<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChanliangPrint.aspx.cs" Inherits="REPORT_cc_ChanliangPrint" Title="工人计件产量报表打印" EnableEventValidation="false"%>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 工人计件产量报表" Font-Size="25px"></asp:Label>
    </p>

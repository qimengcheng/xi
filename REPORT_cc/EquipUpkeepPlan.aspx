<%@ Page Title="设备保养完成情况统计表" Language="C#" MasterPageFile="~/Other/MasterPage.master"
    AutoEventWireup="true" CodeFile="EquipUpkeepPlan.aspx.cs" Inherits="REPORT_cc_EquipUpkeepPlan" %>
                ...
                <fieldset>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 20%; height: 15px;">
                                <asp:TextBox ID="equipmodel" runat="server" Width="155px"></asp:TextBox>
                            </td>
                            <td style="width: 10%" align="center">
                                <asp:Label ID="Label6" runat="server" Text="设备名称："></asp:Label>
                            </td>
                            <td style="width: 20%">
                                <asp:TextBox ID="equipname" runat="server" Width="155px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr style="height: 16px;">
                                ...
                                <td >
                                    <asp:TextBox ID="equipper" runat="server" Width="155px"></asp:TextBox>
                                </td>
                                <td align="center">

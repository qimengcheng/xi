<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MCAPrint.aspx.cs" Inherits="REPORT_cc_MCAPrint" Title="机械维修加工申请汇总表" EnableEventValidation="false"%>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 机械加工维修申请统计表" Font-Size="25px"></asp:Label>
    </p>
                     ...
                     >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="MCA_Product" HeaderText="产品名称" ReadOnly="false" 
                             ...
                             <asp:BoundField DataField="MCA_All" HeaderText="总额" ReadOnly="false" 
                                Visible="true">
                                <ItemStyle />
                            </asp:BoundField>
                         </Columns>

<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeFile="OrderReturnPrint.aspx.cs" Inherits="PurchasingMgt_OrderReturnPrint" %>
...
<body style="text-align: center; width: 1024px; margin: 0 auto; background-color: #FFFFFF;
    ...
    <p style="font-size: 25px;">
            ...
            <asp:Label ID="Label6" runat="server" Text="乐山希尔电子 — 销售退货单" Font-Size="25px"></asp:Label>
                    ...
                    <td >
                        ...
                        <asp:TemplateField HeaderText="序号">
                            <ItemTemplate>
                              ...
                              <asp:BoundField DataField="SMRC_ReturnOrderNum" HeaderText="退货单号" 
                            SortExpression="SMRC_ReturnOrderNum" />
                        <asp:BoundField DataField="SMSO_ComOrderNum" HeaderText="公司订单号" 
                            SortExpression="SMSO_ComOrderNum" />
                        <asp:BoundField DataField="SMRC_ProcessMode" HeaderText="退货方式" SortExpression="SMRC_ProcessMode">
                        ...
                        <asp:BoundField DataField="CRMCIF_Name" HeaderText="客户名称" SortExpression="CRMCIF_Name">
                         ...
                         <asp:BoundField DataField="SMRC_ReturnNum" HeaderText="数量" SortExpression="SMRC_ReturnNum">
                        </asp:BoundField>
                         ...
                         <asp:BoundField DataField="SMRC_MakeTime" HeaderText="退货时间" SortExpression="SMRC_MakeTime"  DataFormatString="{0:yyyy-MM-dd HH:mm:ss }">
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="SMRC_MakeMan" HeaderText="退货人" SortExpression="SMRC_MakeMan">
                        </asp:BoundField>
                        <asp:BoundField DataField="SMRC_ReturnReason" HeaderText="退货原因" SortExpression="SMRC_ReturnReason">
                        </asp:BoundField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnPayDetail.aspx.cs" Inherits="PurchasingMgt_ReturnPayDetail"  MasterPageFile="~/Other/MasterPage.master"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <tr>
        ...
        <td style="width: 10%;" align="right">
                               回款日期:</td>
                            <td colspan="3">
                              <asp:TextBox ID="TextBox2"  onfocus="new WdatePicker(this,'%Y-%M-%D ',true)"  runat="server" ></asp:TextBox>
                              &nbsp;
                                <asp:Label ID="Label1" runat="server" Text="至"></asp:Label>
                                &nbsp; 
                                 <asp:TextBox ID="TextBox5"  onfocus="new WdatePicker(this,'%Y-%M-%D ',true)"  runat="server" ></asp:TextBox>
                            </td>
   </tr>
        <tr>

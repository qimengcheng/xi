...
public partial class Laputa_SunMasterTypeYearTrendsSeries : System.Web.UI.Page
{
    ...
    protected void SearchInStoreMain(object sender, EventArgs e)
    {
        ...
        GridView2.DataSource = lpp.Query_SunMasterYearSeries(DropDownList1.SelectedValue);
        GridView2.DataBind();
        Panel3.Visible = true;
    }
    ...
    {
        GridView2.DataSource = lpp.Query_SunMasterAllYearSeries(DropDownList1.SelectedValue);
    ...
    protected void print(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/report_cc/SunMasterTypeYearTrendsSeriesPrint.aspx?year="+DropDownList1.SelectedValue);
    }
